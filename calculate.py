...
from paramerters import ar, compliance, designer, builder, coll_raticum, delta, dev_footprint, end_customer
...
#print (results)
    ...
    ##class kpi(object):
    #  """docstring for kpi"""
    # def __init__(self, turnover, total_cost, profit, gross_margin, total_recovery, total_footprint ):
